...
export default function PortfolioDetail() {
  return (
    <main className="overflow-hidden">
      ...
      <div>
        {/* Parallax Section */}
        <div className={`${styles.parallaxSection} ${styles.parallaxMusprep}`}>
      ...
      <div className="flex">
          ...
          <article className="px-4 md:px-8">
            ...
            >
              ...
              <div className="flex flex-column gap-3">
                ...
                <p className="my-0">{`Website UI Design, Ecommerce platform`}</p>
              </div>
            ...
            <h2 className="text-5xl">{`A Digital Feast for the Health-Conscious`}</h2>
            <h5 className="text-xl">{`Understanding the Client's Vision`}</h5>
            <div className="flex flex-wrap align-items-center justify-content-around my-8">
              <Image
                alt="article picture 1"
                src={`/pictures/portfolio/musprep/reference1.png`}
                width={480}
                height={180}
              />
            </div>
            ...
            >
              {`The project began with a deep dive into the client's needs and expectations. Through a series of in-depth interviews, I gained a comprehensive understanding of MusclePrepper's business processes, target audience, and brand identity. The insights gathered from these discussions were instrumental in defining the User Requirement Specification (URS) document, which outlined the project's scope, objectives, and technical requirements.`}
            </p>
            <h5 className="text-xl">{`Crafting a Digital Appetite`}</h5>            
            <iframe
              style={{
              ...
              width="100%"
              height="550"
              src="https://embed.figma.com/proto/0DNWGdIpj2RbH6nwHYvIpe/Muscle-Prepper-LoFi?page-id=1101%3A311&node-id=1101-4640&node-type=canvas&viewport=534%2C598%2C0.07&scaling=scale-down-width&content-scaling=fixed&embed-host=share"
              allowfullscreen
            ></iframe>
            <p
              className="my-1 line-height-3"
            ...
            >
              {`With a clear understanding of the project's goals, I embarked on the design phase. I created a visually appealing and user-friendly website design that reflected MusclePrepper's commitment to health and wellness. The design incorporated a clean and modern aesthetic, with a strong emphasis on highlighting the company's delicious and nutritious meal plans.`}
            </p>
            ...
            >
              {`To bring the design to life, I utilized Laravel, a robust PHP framework, to develop a robust and scalable web application. I meticulously translated the design into functional HTML, CSS, and JavaScript code, ensuring that the website was optimized for performance and user experience. The website was designed to be responsive, adapting seamlessly to different screen sizes and devices.`}
            </p>
          </article>
        ...
        <aside
          ...
          style={{
            background:
              "url(/pictures/portfolio/musprep/pattern.png) repeat, linear-gradient(180deg, rgba(60,100,177,1) 0%, rgba(60,100,177,1) 53%)",
          }}
        >
          {/* Client card */}
          <div
          ...
          >
            ...
            <div className="flex flex-column gap-3">
              ...
              <div className="header flex gap-3 pb-2 align-content-center w-full">
                ...
                />
                <div className="flex flex-column justify-content-center gap-1">
                  <span>{`MusclePrepper (Indonesia)`}</span>
                  <small className="font-italic text-blue-500">2021</small>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-column gap-3">
              <h4 className="my-0">Output:</h4>
              <p className="my-0">{`Website UI Design, Landing page, Ecommerce platform`}</p>
            </div>
            {/* <Divider className="border-1 my-1" />
